...
-- Saves me when I forget to press shift when trying to run a nvim cmd
vim.keymap.set('n', ';', ':')
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      cmp.setup {
        ...
        completion = {
          autocomplete = { 'TextChanged' }, -- Only trigger on text change events
          keyword_length = 2, -- Only show completion after typing 2 characters
        },
